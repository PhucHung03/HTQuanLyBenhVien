<?php
    ...
    if (!isset($_SESSION['id']) || !isset($_SESSION['hoTen']) || !isset($_SESSION['user'])) {
        header('location:/HTQuanLyBenhVien-master/index.php?url=dang-nhap');
        exit();
    }
            ...
            <div class="row">
                    <div class="header__top">
                        <ul>
                            ...
                            <li><a href="/HTQuanLyBenhVien-master/public/user/datLichKham.php" class="btn" style="border-radius:20px;background-color: rgb(21, 176, 21); border: none;" >
                                <i  class="fa fa-calendar" style="color: #ffffff;"></i>	<span style="color: #ffffff;padding: 10px;">Đặt lịch khám</span>
                                </a>
                            </li>
                            <li>
                                <a href="/HTQuanLyBenhVien-master/index.php?url=dang-xuat">Thoát !</a></li>
                            </li>
                        </ul>
                    </div>
            </div>
                ...
                <div class="col-lg-8 col-sm-3 ml-5">
                    <div class="header__right">
                        <div class="header__menu">
                            <ul>
                                <li><a href="/HTQuanLyBenhVien-master/index.php?url=trang-chu"><h5>TRANG CHỦ</h5></a></li>
                                <li><a href="/HTQuanLyBenhVien-master/index.php?url=chuyen-khoa"><h5>CHUYÊN KHOA</h5></a></li>
                                <li><a href="/HTQuanLyBenhVien-master/index.php?url=bac-si"><h5>BÁC SĨ</h5></a></li>
                                ...
                                <li><a href="/HTQuanLyBenhVien-master/index.php?url=thanh-tuu"><h5>THÀNH TỰU</h5></a></li>
                                <li><a href=""><h5>TIN TỨC</h5></a></li>
                                <li><a href=""><h5>BỆNH NHÂN</h5></a>
                                    <ul class="dropdown">
                                        <li><a href="/HTQuanLyBenhVien-master/public/user/datLichKham.php">Đặt lịch khám</a></li>
                                        <li><a href="/HTQuanLyBenhVien-master/public/user/xemPhieuKham.php">Xem Phiếu Khám</a></li>
        ...
        <div id="color">
            ...
            <div class="info-section" style="border: 1px solid #ddd;">
                ...
                <div id="button-container">
                    <a href="/HTQuanLyBenhVien-master/public/user/xemPhieuKham.php" class="btn btn-primary">Quay Lại</a>
                </div>
            </div>
        </div>
