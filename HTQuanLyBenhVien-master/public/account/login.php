     ...
     <div class="header-spacing" >
        <div class="login-container">
            ...
            <div class="footer-links mt-3">
                <a href="/HTQuanLyBenhVien-master/public/account/forgotpass.php">Quên mật khẩu?</a> | <a href="/HTQuanLyBenhVien-master/public/account/register.php">Đăng ký tài khoản</a>
            </div>
        </div>
     </div>
