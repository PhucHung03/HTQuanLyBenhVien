<?php
    if (isset($_POST['nut']) == true) {
        ...
        if (!checkdate($thang, $ngay, $nam)) {
            echo "<script>alert('Ngày tháng năm không hợp lệ. Vui lòng kiểm tra lại!'); window.location.href='/HTQuanLyBenhVien-master/public/account/register.php';</script>";
            ...
            <div class="row">
                    <div class="header__top">
                        <ul>
                            ...
                            <li>
                                <a href="/HTQuanLyBenhVien-master/index.php?url=dang-nhap">Đăng nhập</a><span style="color: #ffffff;"> / </span>
                                <a href="/HTQuanLyBenhVien-master/public/account/register.php">Đăng kí</a>
                            </li>
                        </ul>
                    </div>
            </div>
