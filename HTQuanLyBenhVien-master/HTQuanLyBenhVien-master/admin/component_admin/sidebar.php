            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="dangkytaikhoan.php" class="dropdown-item">Đăng Ký Tài Khoản</a>
                            <a href="#1" class="dropdown-item">Đăng Nhập</a>
                            <a href="datlichkham.php" class="dropdown-item">Đặt lịch khám</a>                           
                            <a href="xemphieukham1.php" class="dropdown-item">Xem Phiếu Khám</a>
