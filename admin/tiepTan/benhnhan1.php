<style>
  .container1 {
    width: 80%;           
    max-width: 800px;      /* Giới hạn chiều rộng để phù hợp với màn hình */
    margin: 20px auto;     /* Thêm khoảng cách trên và dưới */
    padding: 20px;
    border: 1px solid #007bff;  
    border-radius: 10px;
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); 
    background-color: #f8f9fa; /* Tông màu sáng cho giao diện dễ nhìn */
  }
  ...
  /* Tiêu đề */
  .card-header h1 {
    color: #007bff;  /* Xanh lam đậm cho tiêu đề */
    font-size: 24px;
    margin-bottom: 20px;
  }
