...
if ($maLichHen) {
    ...
    $sql = "SELECT lhk.maLichHen, lhk.maBenhNhan, bn.tenBenhNhan, lhk.ngayKham, lhk.moTaSucKhoe
        ...
        <?php if ($lichHen): ?>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($lichHen['moTaSucKhoe']); ?></td>
                </tr>
            </table>
            <a href="danh_sach.php" class="btn btn-secondary">Quay lại</a>
        <?php else: ?>
