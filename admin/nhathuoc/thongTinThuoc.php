...
<div class="container">
    ...
    <div class="info-box">
        <?php
            $idsp=$_REQUEST['id'];
            $p->xemthongtinthuoc("SELECT * FROM thuoc where idThuoc = '$idsp' limit 1");
        ?>
    </div>
    <div class="button-container">
        <button class="button back-button"><a href="../index.php?quanli=xem-thuoc-ton-kho" style="color:white;text-decoration:none;">Trở lại</a></button>
    </div>
</div>
</body>