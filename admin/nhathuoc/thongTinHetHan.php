...
<div class="container">
    ...
    <div class="info-box">
        <?php
        $id=$_REQUEST['id'];
            $p->thongTinHetHan("SELECT * FROM thuoc where idThuoc = '$id' limit 1");
        ?>
    </div>

    <div class="button-container">
        <button class="button back-button"><a href="../index.php?quanli=bao-cao-thuoc-het-han" style="text-decoration:none;color:white;">Trở lại</a></button>
