<?php        
        class clsthuoc{
            ...
            public function timKiemThuoc(){
                $link = $this->connect();
                $search = isset($_GET['search']) ? $_GET['search'] : '';
                $sql = "SELECT * FROM thuoc WHERE tenThuoc LIKE '%$search%'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><a href="index.php?quanli=xem-thong-tin-thuoc&id='.$row['idThuoc'].'" ><button class="button"><span style="color:white;">Xem</span></button></a></td>';
                        echo "</tr>";
                    }
                } else {
